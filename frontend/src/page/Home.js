...
import HomeSlider from '../component/Homeslider/slider';
  ...
  return (
    <div className='p-2 md:p-4'>
      ...
      {/* <div className='flex gap-3 bg-white w-36 px-2 items-center rounded-full'>
        ...
        <img
          src='https://thenounproject.com/api/private/icons/4303170/edit/?backgroundShape=SQUARE&backgroundShapeColor=%23000000&backgroundShapeOpacity=0&exportSize=752&flipX=false&flipY=false&foregroundColor=%23000000&foregroundOpacity=1&imageFormat=png&rotation=0'
          alt='Loading'
          className='h-7'
        />
      </div> */}
      <h2 className='text-4xl md:text-7xl font-bold py-3'>
        ...
        <span className='text-green-700 text-5xl md:text-7xl'>Your Home</span>
      </h2>
      <p
        className=''
        style={{ fontSize: '18px', color: '#666', marginBottom: '40px' }}
      >
        Experience the Freshness of Nature with Our Organic Products. Enjoy the
        best quality, pesticide-free and sustainable produce straight to your
        doorstep.
      </p>
      {/* <button className='font-bold bg-green-500 hover:bg-green-600 text-white rounded px-4 py-2'>
        Order Now
      </button> */}
      {/* </div> */}
        ...
        {/* <div className='flex w-full items-center justify-between'>
          ...
          <div className='ml-auto flex gap-4 mb-2'>
            <button
              ...
              className='bg-slate-300 hover:bg-slate-400 text-xl p-2 rounded '
            >
              <GrFormPrevious />
            </button>
            <button

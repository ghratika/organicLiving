        ...
        <Link to={''}>
          <div className='h-15'>
            <img
              ...
              alt='QuickPick'
              className=' '
              style={{ height: '60px', paddingLeft: '6px' }}
            />
          </div>
        </Link>
        ...
        <div className='flex item-center gap-4 md:gap-7'>
          <nav className='flex gap-4 md:gap-7 text-base md:text-lg md:flex hidden'>
            ...
            <Link
              ...
              to={'menu/6656a72306326f21e10004ca'}
            >
              Menu
            </Link>
            <Link
            ...
            {showMenu && (
              <div className='absolute right-2 bg-white py-2 shadow drop-shadow-md flex flex-col min-w-[120px] text-center'>
                ...
                {userData.image ? (
                  ...
                  <Link
                    to={'login'}
                    className='whitespace-nowrap cursor-pointer text-white px-2 bg-green-500'
                  >
                    Login
                  </Link>
                )}
